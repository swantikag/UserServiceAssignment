...
import com.knoldus.userservice.model.{LoginRequest, LoginUser, LoginUserComponent, MasterUser, MasterUserComponent, UserDetails}
import slick.jdbc.MySQLProfile.api._

import scala.concurrent.{ExecutionContext, Future}

class UserDaoImpl(implicit ec:ExecutionContext) extends UserDao with MasterUserComponent with LoginUserComponent {
  this: DB =>
